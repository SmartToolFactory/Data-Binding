...
abstract class BaseAdapter : RecyclerView.Adapter<BaseAdapter.MyViewHolder>() {
    ...
    internal var listener: OnRecyclerViewItemClickListener? = null

    inner class MyViewHolder// TODO #2
    (// each data item is just a string in this case
            private val binding: ViewDataBinding) : RecyclerView.ViewHolder(binding.root), View.OnClickListener {
